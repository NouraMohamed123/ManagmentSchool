                        ...
                        <ul id="students-menu" class="collapse">
                            ...
                            <li>
                                ...
                                <ul id="Graduate students" class="collapse">
                                    <li> <a href="{{route('Graduated.index')}}">{{trans('main_trans.add_Graduate')}}</a> </li>
                                    <li> <a href="{{route('Graduated.create')}}">{{trans('main_trans.list_Graduate')}}</a> </li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subjects">
                            <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans('main_trans.Subject')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('subjects.index')}}">قائمة المواد الدراسيه</a> </li>
                        </ul>
                    </li>
